...
def main():
    ...
    while True:
        ...
        if manzanas_comidas >= 10 and manzanas_comidas % 5 == 0:
        ...
        if velocidad >= 2.7:
            ...
            if posion_tamano.verificar_colision(serpiente.cuerpo[0]):
                posion_tamano.aparecer()
                serpiente.disminuir_tamano()

            if posion_tamano.activa:  # Nueva condición para verificar la activación
                posion_tamano.desaparecer()
                serpiente.disminuir_tamano()
